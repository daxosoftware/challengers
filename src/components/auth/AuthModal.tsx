  ...
  return (
    <AuthErrorBoundary>
      <div className="fixed inset-0 z-[99999] overflow-y-auto">
        ...
        <div className="inline-block align-bottom modal-glass px-4 pt-5 pb-4 text-left overflow-hidden transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full sm:p-6 relative z-[99999]">
          <div className="absolute top-0 right-0 pt-4 pr-4">
            <button
              onClick={onClose}
              className="glass rounded-xl text-white/60 hover:text-frog-primary hover:scale-110 transition-all duration-300 p-2 relative z-[99999]"
            >
              <X className="h-6 w-6" />
            </button>
          </div>
